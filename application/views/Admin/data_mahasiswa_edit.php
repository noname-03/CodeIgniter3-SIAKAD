                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" name="id_mahasiswa" value="<?php echo $mhs->id_mahasiswa ?>">
                                                    <input type="text" class="form-control" name="nim_mahasiswa" value="<?php echo $mhs->nim_mahasiswa ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Nama Mahasiswa</label>
                                                    <input type="text" class="form-control" name="nm_mahasiswa" value="<?php echo $mhs->nm_mahasiswa ?>">
                                                </div>
                                            </div>
                                        </div>
